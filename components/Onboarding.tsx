...
export const Onboarding = ({ onComplete }: OnboardingProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[250] flex flex-col items-center justify-center p-8 bg-[#020617] overflow-hidden">
      {/* Background Decor */}
      <motion.div 
      ...
      <div className="w-full max-w-sm relative z-10">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="relative group">
               ...
               <motion.div 
                 ...
                 className={`
                    w-48 h-48 rounded-[60px] flex items-center justify-center 
               ...
               >
                 ...
                 {React.createElement(slides[step].icon, { size: 72, className: `${slides[step].color} drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]` })}
               </motion.div>
            </motion.div>
            ...
            <div className="space-y-5 px-2">
              ...
              <motion.h2 variants={itemVariants} className="text-5xl font-black font-outfit tracking-tighter text-white leading-[0.9]">
                {slides[step].title}
              </motion.h2>
              
              <motion.p variants={itemVariants} className="text-indigo-200/60 text-lg font-medium leading-relaxed">
                {slides[step].desc}
              </motion.p>
            </div>
          </motion.div>
        ...
        <div className="mt-16 space-y-8">
          ...
          <motion.button 
            ...
            onClick={handleNext}
            className="w-full py-6 bg-white text-black font-black rounded-[32px] text-xl shadow-[0_0_50px_-10px_rgba(255,255,255,0.2)] flex items-center justify-center gap-3 font-outfit relative overflow-hidden group"
          >
